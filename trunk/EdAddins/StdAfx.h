...
#if !defined(AFX_STDAFX_H__E2E8AB47_6935_4866_BE3C_046AA6C7E5BD__INCLUDED_)
#define AFX_STDAFX_H__E2E8AB47_6935_4866_BE3C_046AA6C7E5BD__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in EdAddins.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
//#ifdef _DEMO
//	#define EDADDINS_SSDSDK lisencedlg()
//#else
	#include <ssdsdk.h>
	#define EDADDINS_SSDSDK CHECKVALIDATE
//#endif


extern char *gKeyAddIns;
extern char *gKeyEdAddins;
extern char *gKeyFull;
//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_STDAFX_H__E2E8AB47_6935_4866_BE3C_046AA6C7E5BD__INCLUDED)
