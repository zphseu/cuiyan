...
#if !defined(_WIN32_WCE_NO_PRINTING) && !defined(GRIDCONTROL_NO_PRINTING)
public:
	void SetTitle(LPCTSTR title, LPCTSTR headRight, LPCTSTR footLeft, LPCTSTR footRight)
	{ 
		m_szTitle		= title; 
		m_szHeadRight	= headRight; 
		m_szFootLeft	= footLeft;  
		m_szFootRight	= footRight;
	}
...
protected:
	...
	CString		m_szFootRight;
	CString		m_szHeadRight;
