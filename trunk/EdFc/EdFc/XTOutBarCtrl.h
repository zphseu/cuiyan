...
struct XT_OUTBAR_INFO 
{
	...
	LPCTSTR lpszDll;	// Dll File Name
	LPCTSTR lpszView;	// View Name
};
/////////////////////////////////////////////////////////////////////////////
...
protected:
	...
	CString	m_strData;	// used internally
...
AFX_INLINE LPCTSTR CXTBarItem::GetData() {
	return m_strData;
}
AFX_INLINE void CXTBarItem::SetData(LPCTSTR strData) {
	m_strData = strData;
}
AFX_INLINE CString CXTBarItem::GetName() {
	return m_strName;
}
AFX_INLINE void CXTBarItem::SetName(LPCTSTR strName) {
	m_strName = strName;
}
AFX_INLINE LPCTSTR CXTBarItem::GetDLL() {
	return m_strDll;
}
AFX_INLINE void CXTBarItem::SetDLL(LPCTSTR strDll) {
	m_strDll = strDll;
}
AFX_INLINE LPCTSTR CXTBarItem::GetView() {
	return m_strView;
}
AFX_INLINE void CXTBarItem::SetView(LPCTSTR strView) {
	m_strView = strView;
}
...
AFX_INLINE LPCTSTR CXTBarFolder::GetName() {
	return m_strName;
}
AFX_INLINE void CXTBarFolder::SetName(LPCTSTR strName) {
	m_strName = strName;
}
