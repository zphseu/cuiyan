// EdAddins.cpp : Defines the initialization routines for the DLL.
//
...
class CEdAddinsApp : public CWinApp
{
public:
	CEdAddinsApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CEdAddinsApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CEdAddinsApp)
...
BEGIN_MESSAGE_MAP(CEdAddinsApp, CWinApp)
	//{{AFX_MSG_MAP(CEdAddinsApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CEdAddinsApp object

CEdAddinsApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CEdAddinsApp construction

CEdAddinsApp::CEdAddinsApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CEdAddinsApp initialization

BOOL CEdAddinsApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();	
}

int CEdAddinsApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_EDADDINS_DESCRIPTION);
