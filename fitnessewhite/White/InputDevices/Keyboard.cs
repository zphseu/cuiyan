...
namespace Core.InputDevices
{
    ...
    public class Keyboard : IKeyboard
    {
        ...
        internal virtual void Send(string keysToType, ActionListener actionListener)
        {
            CapsLockOn = false;
        ...
        internal virtual void PressSpecialKey(KeyboardInput.SpecialKeys key, ActionListener actionListener)
        {
            Send(key, true);
            actionListener.ActionPerformed(Action.WindowMessage);
        }
        ...
        internal virtual void LeaveKey(KeyboardInput.SpecialKeys key, ActionListener actionListener)
        {
        ...
        {
            List<KeyboardInput.SpecialKeys> list = new List<KeyboardInput.SpecialKeys>(heldKeys);
            list.ForEach(delegate(KeyboardInput.SpecialKeys key) { LeaveKey(key); });
        }
    }
}