...
void CSizingControlBar::OnNcPaint()
{
    ...
    mdc.FillRect(rcDraw, CBrush::FromHandle(
        (HBRUSH)((INT_PTR)GetClassLong(m_hWnd, GCL_HBRBACKGROUND))));
...
IMPLEMENT_DYNCREATE(CSCBMiniDockFrameWnd, CMiniDockFrameWnd);

BEGIN_MESSAGE_MAP(CSCBMiniDockFrameWnd, CMiniDockFrameWnd)
