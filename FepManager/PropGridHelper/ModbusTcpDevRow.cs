...
namespace FepManager.PropGridHelper
{
    ...
    internal class ModbusEthDevRow
    {
        private DataSet.FepCfg.t_deviceRow m_Row = null;
        private String m_Address = "";
        private String m_Address1 = "";
        private Int32 m_Port = 502;
        private Boolean m_IsMultilink = true;

        public ModbusEthDevRow(DataSet.FepCfg.t_deviceRow row)
	    {
		    m_Row = row;
        ...
        private void ConvertFromRowConn(String s)
        {
            ...
            {
                throw new ArgumentException("无法转换字符串 '" + s + "' 到类型 ModBusEthConnParam");
            }
        }
