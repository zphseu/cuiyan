...
static WCHAR pwchMCIMMControl1LicenseKey[] =
{
...
static WCHAR pwchMSCOMMLibMSComm1LicenseKey[] =
{
...
static WCHAR pwchMSFlexGridLibMSFlexGrid1LicenseKey[] =
{
...
static WCHAR pwchMSMaskMaskEdBox1LicenseKey[] =
{
	0x006D,	0x0067,	0x006B,	0x0067,	0x0074,	0x0067,	
	0x006E,	0x006E,	0x006D,	0x006E,	0x006D,	0x006E,	
	0x0069,	0x006E,	0x0069,	0x0067,	0x0074,	0x0068,	
...
static WCHAR pwchMSDBGridDBGridLicenseKey[] =
{
...
static WCHAR pwchPicClipPictureClip1LicenseKey[] =
{
...
CDynDialogItemEx::RuntimeLicense CDynDialogItemEx::m_RuntimeLicenses[] = 
{
...
UINT CDynDialogItemEx::m_nNextID = WM_USER + 1100;  // We have to start somewhere...

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CDynDialogItemEx::CDynDialogItemEx() : CWnd()
{
...
LPTSTR CDynDialogItemEx::GetClassNameByType(DLGITEMTEMPLATECONTROLS TypeControl)
{
	switch(TypeControl) {
	case BUTTON:
		return _T("BUTTON");
...
UINT CDynDialogItemEx::InitDialogItem(DLGITEMTEMPLATECONTROLS TypeControl,
	DWORD dwStyle, DWORD dwExtendedStyle, LPRECT pRect, LPCTSTR lpszCaption,
	UINT nID /*= 0*/, BOOL bSubclassed /*= FALSE*/,	VOID *pData /*= NULL*/)
{
	...
	m_pData = pData;
	return m_ControlID = (nID == 0) ? GetNewUniqueID() : m_ControlID = nID;
}
...
BSTR CDynDialogItemEx::GetRuntimeLicense(CString &strControlName)
{
	...
	int i = 0;
	while (m_RuntimeLicenses[i].lpszRegisteredControlName != NULL) {
		if (strControlName.Compare(m_RuntimeLicenses[i].lpszRegisteredControlName) == 0) {
			bstrLicKey = ::SysAllocStringLen(m_RuntimeLicenses[i].wchLicenseKey, m_RuntimeLicenses[i].lLicenseLength/sizeof(WCHAR));
			break;
		}
		i++;
	}
...
UINT CDynDialogItemEx::GetNewUniqueID()
{
	m_nNextID++;
	return m_nNextID - 1;
}
