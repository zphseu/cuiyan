...
BOOL CRegistry::CreateKey(LPCTSTR lpszPath, DWORD dwOptions)
{
	ASSERT(m_hKey);
	ASSERT(lpszPath);
	...
	LONG lResult = RegCreateKeyEx(m_hKey, lpszPath, NULL, NULL, dwOptions, KEY_ALL_ACCESS, NULL, &m_hKey, &dwDisp);
